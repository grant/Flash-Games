package org.flixel.system
{
	...
	{
		//[Embed(source="/logo.png")] protected var ImgLogo:Class;
		//[Embed(source="/logo_red.png")] protected var ImgLogoRed:Class;
		...
		protected var _logor:Bitmap;
		protected var _logofill:Bitmap;
		/**
		 * @private
		 */
		 ...
		 */
		public var myURL:String = "projects.iarke.us";
		/**
		...
		protected function create():void
		{
			...
			_buffer.addChild(new Bitmap(new BitmapData(_width,_height,false,0x9b9b9b)));
			var bitmap:Bitmap;
			...
			_text = new TextField();
			_text.defaultTextFormat = new TextFormat("system",16,0x333333,null, null, null, null, null, "center");
			...
			_logo.y = (_height-_logo.height)/2 - 20;
			_buffer.addChild(_logo);
			
			_logor = new ImgLogoRed();
			//_logo.scaleX = _logo.scaleY = _height/8;
			_logofill = new Bitmap(new BitmapData(271, 44, true, 0xff0000));
			_logofill.x = _logo.x;
			_logofill.y = _logo.y;
			_buffer.addChild(_logofill); */
		...
		protected function update(Percent:Number):void
		{
			...
			_text.text = Math.floor(Percent*100)+"%";
			_text.setTextFormat(_text.defaultTextFormat);
			
			//_logofill.bitmapData.copyPixels(_logor.bitmapData, new Rectangle(0, 0, 271 * Percent, 44), new Point(0, 0));
