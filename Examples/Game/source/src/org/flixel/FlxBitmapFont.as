package org.flixel
{
	...
	public class FlxBitmapFont
	{
		 ...
		 */
		public function FlxBitmapFont(Image:Class=null, Width:uint=0, Height:uint=5, HorizontalPadding:int=1, VerticalPadding:int=5, Alphabet:String=" !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~")
		{
			if (Image == null)
