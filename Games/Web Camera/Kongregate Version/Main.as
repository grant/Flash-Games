...
package {
	...
	[SWF(width="900", height="712")];//600 by 475
	public class Main extends Sprite {
		...
		private function loadKongAPI():void {
		...
		private function snapClick(e:MouseEvent):void {
			...
			snapNumber++;
			kongregate.stats.submit("Snaps",snapNumber);
			kongregate.images.submitAvatar(bm, onAvatarComplete);
		}
