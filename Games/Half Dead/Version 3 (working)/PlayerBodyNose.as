//The player body's nose
//par:PlayerBody
//children:none
package {
	import flash.display.MovieClip;
	public class PlayerBodyNose extends MovieClip implements I_Positionable, I_Typeable {
		//constants
		const DEFAULT_TYPE:uint = 0;
		var POSITIONS:Array;//hash map (index:frame #,data:Array(x,y))
		//properties
		var type:uint;
		public function PlayerBodyNose():void {
			setup();
